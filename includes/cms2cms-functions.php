...
class CmsPluginFunctionsK2
{
    ...
    private $jsConfig = '{
        ...
        "wp_feedback"     : "//wordpress.org/support/plugin/cms2cms-joomla-k2-to-wp-website-migration/reviews",
    ...
    {
        $cms2cms_k2_access_login = get_option('cms2cms-k2-login');
        $cms2cms_k2_access_key   = get_option('cms2cms-k2-key');

        return array(
            'email'     => $cms2cms_k2_access_login,
            'accessKey' => $cms2cms_k2_access_key
        );
    }
    ...
    public function isActivated()
    {
        ...
        return ($cms2cms_k2_access_key != false);
    }
    ...
    public function getOptions()
    {
        ...
        $login = get_option('cms2cms-k2-login');
    ...
    public function saveOptions()
    {
        ...
        if ( $key && $login ) {
            ...
            add_option('cms2cms-k2-key', $key);

            delete_option('cms2cms-k2-login');
            add_option('cms2cms-k2-login', $login);

            delete_option('cms2cms-k2-depth');
            add_option('cms2cms-k2-depth', $bridge_depth);
    ...
    {
        return $this->__('K2', 'cms2cms-k2-migration');
    }
    ...
    {
        return $this->__('WordPress', 'cms2cms-k2-migration');
    }
    ...
    {
        return sprintf(
            $this->__('CMS2CMS: Automated %s to %s Migration ', 'cms2cms-k2-migration'),
    ...
    {
        return sprintf(
            $this->__('%s to %s', 'cms2cms-k2-migration'),
            $this->getPluginSourceName(),
            $this->getPluginTargetName()
        );
    }
    ...
    public function logOut()
    {
        if (isset($_REQUEST['_wpnonce'])) {
            ...
            if ($this->verifyFormTempKey($nonce, 'cms2cms_k2_logout')
                && $_POST['cms2cms_k2_logout'] == 1
            ) {
                $this->clearOptions();
            }
        }
